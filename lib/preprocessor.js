...
var createCoveragePreprocessor = function(logger, basePath, reporters, coverageReporter) {
  ...
  return function(content, file, done) {
    ...
    log.debug('instrumenterOptions ', coverageReporter.instrumenterOptions);
    var opts = coverageReporter ? coverageReporter.instrumenterOptions || {} : {};
    var instrumenter = new instrumenters[instrumenterLiteral].Instrumenter({
        debug: opts.debug || false,
        walkDebug: opts.walkDebug || false,
        coverageVariable: opts.coverageVariable || '__coverage__',
        codeGenerationOptions: opts.codeGenerationOptions || undefined,
        noAutoWrap: opts.noAutoWrap || true,
        noCompact: opts.noCompact || true,
        embedSource: opts.embedSource || false,
        preserveComments: opts.preserveComments || true
    });
